package dong.duan.photoedittor.edit_library.drawboard.view;
...
import dong.duan.photoedittor.edit_library.drawboard.draw.Draw;
import dong.duan.photoedittor.edit_library.drawboard.draw.DrawArrow;
import dong.duan.photoedittor.edit_library.drawboard.draw.DrawBitmap;
import dong.duan.photoedittor.edit_library.drawboard.draw.DrawCircle;
import dong.duan.photoedittor.edit_library.drawboard.draw.DrawLine;
import dong.duan.photoedittor.edit_library.drawboard.draw.DrawOval;
import dong.duan.photoedittor.edit_library.drawboard.draw.DrawPath;
import dong.duan.photoedittor.edit_library.drawboard.draw.DrawPoint;
import dong.duan.photoedittor.edit_library.drawboard.draw.DrawRect;
import dong.duan.photoedittor.edit_library.drawboard.draw.DrawText;
...
public class DrawBoardView extends View {
    ...
    @IntDef({DrawMode.DRAW_PATH, DrawMode.DRAW_POINT, DrawMode.DRAW_LINE,
            ...
            DrawMode.DRAW_ARROW, DrawMode.DRAW_BITMAP, DrawMode.ERASER})
    ...
    public void penSize(float value){
    ...
    private void init(Context context, @Nullable AttributeSet attrs){
        ...
        drawTextSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,13f,displayMetrics);
    ...
    private void initDrawMap(){
        ...
        drawMap.put(DrawMode.DRAW_ARROW, DrawArrow.class);
